...
/// @brief Brgemm default pre_processing functor. Specialized for Xe architecture.
template <typename tile_shape_>
class pre_processing_default_t<tile_shape_, gpu_arch::Xe> {
...
template <typename tile_shape_>
class pre_processing_matA_neg_filter_t<tile_shape_, gpu_arch::Xe> {
    using tile_shape = tile_shape_;
    using work_group_t = typename tile_shape::work_group_t;
