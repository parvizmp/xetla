...
class gemm_t<dispatch_policy_persistent_thread<wg_num_n_>, brgemm_t_,
        epilogue_t_> {
    ...
    using dispatch_policy = dispatch_policy_persistent_thread<wg_num_n>;
...
public:
    ...
    static cl::sycl::range<3> get_group_range(
        ...
        uint32_t group_range_n = (matrix_n + wg_tile_n - 1) / wg_tile_n; //45
    ...
    __XETLA_API KERNEL_FUNC void operator()(xetla_exec_item<3> &ei,
        ...
        // matAcc.reg = ei.get_group_range(1);
